...
function setup()
    ...
    -- Key 2: Party Popper (Pink)
    keybow.set_pixel(2, 255, 0, 128)
    -- Key 3: Clapping (Yellow)
    keybow.set_pixel(3, 255, 255, 0)
    -- Key 4: Laugh / Joy (Blue)
    keybow.set_pixel(4, 0, 128, 255)
    -- Key 5: Surprised (Purple)
    keybow.set_pixel(5, 128, 0, 255)
    -- Key 6: Cry (Light Blue)
    keybow.set_pixel(6, 0, 255, 255)
    -- Key 7: Thinking (Green)
    keybow.set_pixel(7, 0, 255, 0)
    -- Key 8: Thumbs Down (Orange)
    keybow.set_pixel(8, 255, 128, 0)
